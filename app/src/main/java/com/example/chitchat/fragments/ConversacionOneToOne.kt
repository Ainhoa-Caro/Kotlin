...
import com.example.chitchat.adaptadores.MensajesAdapter
...
class ConversacionOneToOne : Fragment() {
    ...
    private fun initViews() {
        ...
        msjRecylerView.adapter = MensajesAdapter(userLogueadoId)
        ...
        ref.addValueEventListener(object: ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                snapshot.children.forEach {
                    ...
                    if (mensajeList != null) {
                        (msjRecylerView.adapter as MensajesAdapter).setData(mensajeList)
                    }
                }
            }
